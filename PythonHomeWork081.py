...
4 - Изменить контакт\n5 - Удалить контакт\n6 - Просмотреть все контакты\n0 - Выйти из приложения\n')
        ...
        if user_choice == '1':
            ...
            import_data(file_to_add, contact)
        elif user_choice == '2':
            contact_list = read_file_to_dict(contact)
...
def import_data(file_to_add, contact):
    try:
        with open(file_to_add, 'r', encoding='utf-8') as new_contacts, open(contact, 'a', encoding='utf-8') as file:
